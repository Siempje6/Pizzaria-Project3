...
<div class="container mx-auto p-6">
    <h1 class="text-3xl font-bold mb-6 text-center">Nieuwe Gebruiker Toevoegen</h1>
    ...
    <form action="{{ route('admin.store') }}" method="POST">
        ...
        <div class="space-y-4">
            <div>
                ...
                <input type="text" name="name" id="name" class="w-full p-3 border rounded" value="{{ old('name') }}" required>
            </div>

            <div>
                <label for="email" class="block text-lg">Email</label>
                <input type="email" name="email" id="email" class="w-full p-3 border rounded" value="{{ old('email') }}" required>
            </div>
            ...
            <div class="flex justify-center">
                <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white px-6 py-2 rounded">Gebruiker Toevoegen</button>
            </div>
        </div>
    </form>
</div>
